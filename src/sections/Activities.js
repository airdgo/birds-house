...
export const Activities = () => {
	...
	return (
		<section
			id="activities"
			className="relative min-h-[200vh] overflow-auto bg-primary py-[20vw]"
		>
			<ScrollTrigger
				start="center center"
				end="200% center"
			...
			>
				...
				>
					<div className="flex h-full w-full flex-col items-center overflow-hidden md:flex-row md:overflow-visible first:[&>div]:rotate-12 md:first:[&>div]:rotate-0 [&:nth-child(3)]:[&>div]:rotate-flip-12 md:[&:nth-child(3)]:[&>div]:rotate-0 [&:nth-child(5)]:[&>div]:-rotate-flip-12 md:[&:nth-child(5)]:[&>div]:rotate-0 last:[&>div]:[&>span]:mb-7">
