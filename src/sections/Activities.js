	...
	return (
		...
		>
			<div
				...
				className="flex h-full w-full flex-col items-center overflow-hidden no-scrollbar md:flex-row md:overflow-auto first:[&>div]:rotate-12 md:first:[&>div]:rotate-0 [&:nth-child(3)]:[&>div]:rotate-flip-12 md:[&:nth-child(3)]:[&>div]:rotate-0 [&:nth-child(5)]:[&>div]:-rotate-flip-12 md:[&:nth-child(5)]:[&>div]:rotate-0 last:[&>div]:[&>span]:mb-7"
			>
